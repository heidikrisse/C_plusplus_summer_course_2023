...
public:
    ...
    // Default constructors and assignment operators to make Grid copyable and movable:
    Grid(const Grid &) = default;                // Copy constructor
    Grid(Grid &&) noexcept = default;            // Move constructor
    Grid &operator=(const Grid &) = default;     // Copy assignment operator
    Grid &operator=(Grid &&) noexcept = default; // Move assignment operator
